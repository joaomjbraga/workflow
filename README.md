...
- Instaladores para: Docker (e gestão de grupo), NVM + Node.js (v22), Go (pacote da distro ou fallback por tarball), Starship, Zsh (com plugins) e Android Studio (via Flatpak).
